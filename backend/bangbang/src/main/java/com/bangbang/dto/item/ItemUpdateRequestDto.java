...
public class ItemUpdateRequestDto {
  ...
  @Builder
  public ItemUpdateRequestDto(long item_id, Integer item_type, Integer item_building_type,
      Integer item_zonecode, Integer item_deal_type, Integer item_supply_area,
      Integer item_exclusive_area, Integer item_total_floor, Integer item_floor,
      Integer item_heating,
      Integer item_move_in_type, String item_move_in_date, Integer item_manage_fee,
      Integer item_manage_type, String item_title, String item_description,
      String item_buildingcode,
      String item_build_year, String item_road_name, String item_road_name_bonbun,
      String item_roadname_bubun, String item_roadname_code, String item_dong, String item_bonbun,
      String item_bubun, String item_sigungucode, String item_eubmyundongcode, String item_dongcode,
      String item_building_name, String item_jibun, String item_lng, String item_lat,
      boolean item_deal_complete, long broker_id, Integer item_status, Integer item_room,
      Integer item_toilet) {
