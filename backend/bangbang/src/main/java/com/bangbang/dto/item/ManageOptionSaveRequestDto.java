...
public class ManageOptionSaveRequestDto {
    ...
    @Builder
    public ManageOptionSaveRequestDto(boolean manage_option_internet, boolean manage_option_tv, boolean manage_option_clean, boolean manage_option_water, boolean manage_option_gas, boolean manage_option_electric, String manage_option_etc, long item_id) {
