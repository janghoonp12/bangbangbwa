...
@Getter
@NoArgsConstructor
public class ItemPriceSaveRequestDto {
    ...
    @Builder
    public ItemPriceSaveRequestDto(long item_id, Integer item_price_buy_house, Integer item_price_house_deposit, Integer item_price_month_deposit, Integer item_price_month_rent) {
