...
public class OptionUpdateRequestDto {
  ...
  @Builder
  public OptionUpdateRequestDto(long option_id, boolean option_elevator, boolean option_veranda, boolean option_parking, boolean option_duplex, boolean option_separation, boolean option_induction, boolean option_microwave, boolean option_aircon, boolean option_washer, boolean option_tv, boolean option_closet, boolean option_bed, boolean option_table, boolean option_shoe, boolean option_bidet, boolean option_gasrange, boolean option_refrigerator, boolean option_doorlock, long item_id) {
