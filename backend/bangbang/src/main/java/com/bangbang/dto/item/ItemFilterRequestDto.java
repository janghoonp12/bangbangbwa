...
public class ItemFilterRequestDto {
    ...
    public ItemFilterRequestDto(int[] item_type, int[] item_deal_type, int[] item_price_buy_house, int[] item_price_house_deposit, int[] item_price_month_rent, int[] item_floor, int[] item_build_year, Option option) {
